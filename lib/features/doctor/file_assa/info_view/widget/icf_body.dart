              ...
              child: Column(
                ...
                children: [
                  ...
                  InfoRowItem(
                      // 
                      title: "Vision",
                      value: controlBodyFunction.vision.text),
                  InfoRowItem(
                      // 
                      title: "Hearing",
                  ...
                  RowItemRightLeft(
                      ...
                      title: 'Dorsiflexors'),
                  RowItemRightLeft(
                      right: controlBodyFunction.shoulderFlexorsMuscleRight.text,
                      left: controlBodyFunction.shoulderFlexorsMuscleLeft.text,
                       
                      title: 'Shoulder flexors'),
                  RowItemRightLeft(
                      right: controlBodyFunction.shoulderExtensorsMuscleRight.text,
                      left: controlBodyFunction.shoulderExtensorsMuscleLeft.text,
                       
                      title: 'Shoulder Extensors'),
                  RowItemRightLeft(
                      right: controlBodyFunction.shoulderAbductorsMuscleRight.text,
                      left: controlBodyFunction.shoulderAbductorsMuscleLeft.text,
                  ...
                  RowItemRightLeft(
                      right: controlBodyFunction.fingerExtensorsMuscleRight.text,
                  ...
                  InfoRowItem(
                      // 
                      title: 'Hip',
                      value: controlBodyFunction.hip.text),
                  InfoRowItem(
                      // 
                      title: 'knee',
                      value: controlBodyFunction.knee.text),
                  InfoRowItem(
                      // 
                      title: 'Ankle',
                      value: controlBodyFunction.ankle.text),
                  InfoRowItem(
                      // 
                      title: 'shoulder',
                  ...
                  InfoRowItem(
                      // 
                      title: 'elbow',
                      value: controlBodyFunction.elbow.text),
                  InfoRowItem(
                      // 
                      title: 'note',
                      value: controlBodyFunction.note.text),
                  InfoRowItem(
                      // 
                      title: 'Deformities',
                  ...
                  InfoRowItem(
                      // 
                      title: 'Spine',
                      value: controlBodyFunction.spine.text),
                  InfoRowItem(
                      // 
                      title: 'Pelvic',
                      value: controlBodyFunction.pelvic.text),
                  const Text('Hip',
                      style:
                          TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                  InfoRowItem(
                      // 
                      title: 'Rt',
                      value: controlBodyFunction.rt.text),
                  InfoRowItem(
                      // 
                      title: 'Lf',
                      value: controlBodyFunction.lf.text),
                ],
              ),
            ),
          );
