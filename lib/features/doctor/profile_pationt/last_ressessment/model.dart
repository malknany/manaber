...
class LastReassessmentModel {
  List<TextEditingController> controles;
  LastReassessmentModel({
    required this.controles,
  });
}

class ModelLastReassessment {
  ModelLastReassessment({
    required this.id,
    required this.name,
    required this.steps,
  ...
  ModelLastReassessment.fromJson(Map<String, dynamic> json){
    id = json['id'];
    name = json['name'];
